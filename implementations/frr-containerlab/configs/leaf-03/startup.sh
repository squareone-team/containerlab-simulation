...
if ip link show eth6 >/dev/null 2>&1; then ip link set eth6 master br0; bridge vlan add vid 60 dev eth6 pvid untagged; fi

for V in 10030 10040 10050 10060 10080; do
...
# eth9 = ntp-server 
ip link set eth9 master br0
bridge vlan add vid 50 dev eth9 pvid untagged
