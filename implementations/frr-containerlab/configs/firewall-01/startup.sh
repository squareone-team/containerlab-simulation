#!/bin/sh
# Startup script for firewall-01
# ESI Datacenter - Ring 1 HA Firewall Pair

set -e

echo "[*] Firewall-01 startup script starting..."
...
#!/bin/sh
echo "[+] Firewall-01 became MASTER for Ring1_VIP - VIP 192.168.1.254 is now active" | logger -t keepalived
...
#!/bin/sh
echo "[*] Firewall-01 became BACKUP for Ring1_VIP" | logger -t keepalived
NOTIFY_BACKUP
...
#!/bin/sh
echo "[-] Firewall-01 entered FAULT state for Ring1_VIP" | logger -t keepalived
...
echo "[+] Firewall-01 startup completed successfully"
echo ""
echo "=========================================="
echo "Firewall-01 Status:"
echo "=========================================="
