...
- `cluster_public_dmz`: `192.168.100.0/24`
...
- DMZ isolation: explicit drops between `192.168.100.0/24` and all internal
  clusters
...
- Orientation subnet in policy is `192.168.90.0/24` (not DMZ).
- DMZ subnet is `192.168.100.0/24` and treated separately with structural
  isolation.
