...
| `docker exec clab-esi-datacenter-student-bp-01 nslookup dmz-server-01.esi.internal 192.168.50.30` | checks campus clients can resolve published DMZ records | returns `198.51.100.10` |
