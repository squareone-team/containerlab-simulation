...
```bash
implementations/frr-containerlab/tests/firewall_inpath_validation.sh
implementations/frr-containerlab/tests/dns_verify.sh
implementations/frr-containerlab/tests/dhcp_verify.sh
implementations/frr-containerlab/tests/ntp_verify.sh
implementations/frr-containerlab/tests/snmp_verify.sh
```
